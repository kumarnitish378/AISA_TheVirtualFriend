...
font = "Roboto Mono"
label = Label(root,text="Longitudinal Modulus of Fiber, Ef1 (Gpa): " ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=0,column=0)

label = Label(root,text="Transverse Modulus of Fiber, Ef2 (Gpa)  : " ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=1,column=0)

label = Label(root,text="Poisson’s Ratio Fiber, nu_f : ",borderwidth=5, font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=2,column=0)

label = Label(root,text="Shear Modulus of Fiber, Gf (Gpa) : " ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=3,column=0)

label = Label(root,text="Modulus of Matrix, Em (Gpa) : " ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=4,column=0)

label = Label(root,text="Poisson’s Ratio Matrix, nu_m : " ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=5,column=0)

label = Label(root,text="Volume fraction of Fiber, Vf : " ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=6,column=0)

label = Label(root,text="Number of Plies :  " ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=7,column=0)

label = Label(root,text="Thickness of Composite (mm) : ",borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=8,column=0)

label = Label(root,text="Orientation of Plies : ", borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=9,column=0)

button1= Button(root,borderwidth=1, text="Calculate", font=(font, 15, 'bold'), command = add,bg="#001254",fg="green")
button1.grid(row=10,column=0, pady=5)

# ------------------------------------------------ #



entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=zeroth_var)
entry1.grid(row=0, column=1)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=first_var)
entry1.grid(row=1, column=1)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=Second_var)
entry1.grid(row=2, column=1)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=Third_var)
entry1.grid(row=3, column=1)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=Foth_var)
entry1.grid(row=4, column=1)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=Fift_var)
entry1.grid(row=5, column=1)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=sixeth_var)
entry1.grid(row=6, column=1)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=eigth_var)
entry1.grid(row=7, column=1)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=nineth_var)
entry1.grid(row=8, column=1)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=tenth_var)
entry1.grid(row=9, column=1)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=result)
entry1.grid(row=10, column=1)

# For Another purpose

label = Label(root,text="Dummy Value 1:" ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=0,column=2)

label = Label(root,text="Dummy Value 2:" ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=1,column=2)

label = Label(root,text="Dummy Value 3:",borderwidth=5, font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=2,column=2)

label = Label(root,text="Dummy Value 4:" ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=3,column=2)

label = Label(root,text="Dummy Value 5:" ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=4,column=2)

label = Label(root,text="Dummy Value 6:" ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=5,column=2)

label = Label(root,text="Dummy Value 7:" ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=6,column=2)

label = Label(root,text="Dummy Value 8:" ,borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=7,column=2)

label = Label(root,text="Dummy Value 9:",borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=8,column=2)

label = Label(root,text="Dummy Value 10:", borderwidth=5,font=(font,15,'bold'),bg="#5a5663",fg="black", justify=LEFT)
label.grid(row=9,column=2)

# Note: put the Function name only, in command which you want to call. ie.command=function_name
button1= Button(root,borderwidth=1, text="Submit", font=(font, 15, 'bold'), command =getDummyvalue,bg="#001254",fg="green")
button1.grid(row=10,column=2, pady=5)

# ------------------------------------------------ #

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=value1)
entry1.grid(row=0, column=3)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=value2)
entry1.grid(row=1, column=3)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=value3)
entry1.grid(row=2, column=3)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=value4)
entry1.grid(row=3, column=3)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=value5)
entry1.grid(row=4, column=3)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=value6)
entry1.grid(row=5, column=3)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=value7)
entry1.grid(row=6, column=3)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=value8)
entry1.grid(row=7, column=3)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=value9)
entry1.grid(row=8, column=3)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=value10)
entry1.grid(row=9, column=3)

entry1=Entry(root, borderwidth=1, font=(font, 10, 'bold'), relief=GROOVE,bg='white', textvariable=value11)
